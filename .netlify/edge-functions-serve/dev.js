...
const functions = {}; const metadata = { functions: {} };
      ...
      try {
        const { default: func } = await import("file:///C:/Users/patha/OneDrive/Desktop/imdb/.netlify/edge-functions/next-dev/index.js");

        if (typeof func === "function") {
          functions["next-dev"] = func;
          metadata.functions["next-dev"] = {"url":"file:///C:/Users/patha/OneDrive/Desktop/imdb/.netlify/edge-functions/next-dev/index.js"}
        } else {
